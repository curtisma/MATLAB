function [ TF_decomp ] = decomp_write_tf_vhdl(cdn_model,fid,out_num,fct_name,Num,Den,ind_imp)
...
for i=1:size(sub_fct_str,2)
    ...
    write_vhdl_vector(fid, ['Out_' num2str(out_num) '_Num_' fct_name '_' num2str(i)], sub_fct_str(1,i).Num);
    write_vhdl_vector(fid, ['Out_' num2str(out_num) '_Den_' fct_name '_' num2str(i)], sub_fct_str(1,i).Den);
